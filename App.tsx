...
function App(): React.JSX.Element {
  ...
  useEffect(() => {
    if (Platform.OS === 'ios') {
    // Initialize Apple Pay and use ApplePayModule methods
    try {
      ApplePayModule.initialize('3240f0eae70a81ae1f731e7559703dd2', '1e1360-33.myshopify.com');
    } catch (error) {
      console.error('Error initializing Apple Pay:', error);
    }
  } else {
    console.log('Apple Pay is not available on Android');
  }
